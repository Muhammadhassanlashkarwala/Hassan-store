...
function showCards() {
   ...
   for (let i = 0; i < cardData.products.length; i++) {
       divCards.innerHTML += `
           <div class="box">
               <img id="product" src="${cardData.products[i].thumbnail}" alt="">
               <h1 id="title"><span>Title: </span> ${cardData.products[i].title}</h1>
               <h4 id='category'><span>Category: </span>${cardData.products[i].category}</h4>
